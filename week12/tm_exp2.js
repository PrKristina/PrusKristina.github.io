	...
	if(frameCount % skipCount == 0)
	{
		...
		else
		{
...

			{
                           ...
                           const v1 = [hands[0].annotations.indexFinger[i][3][0] - hands[0].annotations.indexFinger[i][0][0], hands[0].annotations.indexFinger[i][3][1] - hands[0].annotations.indexFinger[i][0][1]];
                           const v2 = [hands[0].annotations.indexFinger[i+1][3][0] - hands[0].annotations.indexFinger[i+1][0][0], hands[0].annotations.indexFinger[i+1][3][1] - hands[0].annotations.indexFinger[i+1][0][1]];
